...
const Login = () => {
  ...
  return (
    <Box style={{ textAlign: 'center' }} mt={{ base: '20%', md: '10%', sm: '20%' }}>
      ...
      <form onSubmit={onSubmit} style={{ textAlign: "center" }}>
        <Box className='input-icons'>
          ...
          <Input required className='input-field' w="300px" type={"text"} placeholder="Enter Username" value={name} name="name" onChange={handleChange} />
          <span style={{color:'red', marginLeft:'1px', fontSize:'22px'}}>*</span>
        </Box>
